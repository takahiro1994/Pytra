...
from toolchain.emit.julia.emitter.julia_native_emitter import JuliaNativeEmitter
...
class JuliaLegacyEmitterBridge:
    """Thin bridge from toolchain2 bootstrap output to the legacy Julia emitter."""
