...
def _source_path_for_module_id(module_id: str) -> str:
    if module_id == "toolchain.optimize.passes":
...
def _compile_jv_stub() -> dict[str, JsonVal]:
    ...
    return _module_doc("toolchain.compile.jv", body)
...
def _common_types_stub() -> dict[str, JsonVal]:
    ...
    return _module_doc("toolchain.common.types", body)
...
def _optimize_passes_stub() -> dict[str, JsonVal]:
    ...
    return _module_doc("toolchain.optimize.passes", body)
...
def _builtin_registry_stub() -> dict[str, JsonVal]:
    ...
    return _module_doc("toolchain.resolve.py.builtin_registry", body)


_STUB_BUILDERS: dict[str, callable] = {
    "toolchain.common.types": _common_types_stub,
    "toolchain.compile.jv": _compile_jv_stub,
    "toolchain.link.expand_defaults": _expand_defaults_stub,
    "toolchain.optimize.passes": _optimize_passes_stub,
    "toolchain.parse.py.nodes": _parse_nodes_stub,
    "toolchain.parse.py.parser": _parse_parser_stub,
    "toolchain.resolve.py.builtin_registry": _builtin_registry_stub,
    "toolchain.resolve.py.normalize_order": _normalize_order_stub,
}
