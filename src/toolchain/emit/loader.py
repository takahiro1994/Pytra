...
def copy_native_runtime(output_dir: str, lang: str) -> None:
    ...
    files already generated by the emitter (e.g. std/time.js generated
    from .east should not be overwritten by std/time_native.js copy).
    """
...
def emit_all_modules(
    ...
    *,
    ...
    if lang != "":
        copy_native_runtime(output_dir, lang)
