#!/usr/bin/env python3
"""Swift backend: manifest.json → Swift multi-file output."""
...
def main() -> int:
    ...
    if len(argv) == 0 or argv[0] in ("-h", "--help"):
        print("usage: toolchain.emit.swift MANIFEST.json --output-dir DIR")
        return 0

    input_path = ""
    output_dir = "work/tmp/swift"
    i = 0
    while i < len(argv):
        tok = argv[i]
    ...
    return emit_all_modules(input_path, output_dir, ".swift", transpile_to_swift, lang="swift")
