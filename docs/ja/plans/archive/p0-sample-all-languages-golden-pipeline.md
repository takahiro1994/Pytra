...
4. 横断結果の収束
   - 完了時点で失敗言語が残らないことを確認。
   - 結果を `docs/ja/todo/index.md` と `docs/ja/README.md` / `readme.md` の対応更新（差分が出た場合）へ接続。
...
- `P0-SAMPLE-GOLDEN-ALL-01-S8`: 全言語集約結果を `docs/ja/README.md` / `readme.md` のサンプル実行状況とリンクへ反映
