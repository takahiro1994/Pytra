<a href="../../../en/plans/archive/20260308-p0-pytra-cli-cpp-maxopt-linked-build.md">
...
- `python3 tools/check/runtime_parity_check.py --targets cpp --case-root sample --cpp-codegen-opt 3 --east3-opt-level 2`
...
- 2026-03-08: `S3-02` として `python3 tools/check/runtime_parity_check.py --targets cpp --case-root sample --cpp-codegen-opt 3 --east3-opt-level 2` を実行し、`SUMMARY cases=18 pass=18 fail=0` を確認した。
