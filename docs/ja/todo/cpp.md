...
1. [ ] [ID: P0-CPP-LINT-PYRANGE-S1] `_emit_range_call_contains_expr` を `RangeExpr` ノード判定に変更し、`"py_range"` ハードコードを削除する
2. [ ] [ID: P0-CPP-LINT-PYRANGE-S2] `check_emitter_hardcode_lint.py --lang cpp` で `runtime_symbol` が 0 件になることを確認する
