...
最終更新: 2026-04-01（P0-TS-NEW-FIXTURES 完了、P0-TS-STDLIB 完了、P0-TS-LINT-V2 完了、S1/S2/S3/S4/S5 完了、P0-TS-LINT-FIX 完了、P0-TS-TYPE-MAPPING 完了、P8-TS-EMITTER-S6/S7 完了、P0-JS-RUNTIME-ESM 完了）
...
1. [ ] [ID: P0-TS-TYPEID-S1] TS emitter からクラスへの `PYTRA_TYPE_ID` フィールド挿入を削除する
2. [ ] [ID: P0-TS-TYPEID-S2] `pytra_isinstance` を JS/TS ネイティブの `instanceof` に置換する
3. [ ] [ID: P0-TS-TYPEID-S3] `pytra_built_in_py_runtime` から `PYTRA_TYPE_ID` export を削除する
4. [ ] [ID: P0-TS-TYPEID-S4] fixture + sample + stdlib の TS/JS parity に回帰がないことを確認する
