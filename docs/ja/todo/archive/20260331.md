...
1. [x] P1-JAVA-EMITTER-S1〜S6 — emitter 実装、mapping.json、fixture 131/131 + sample 18/18 + stdlib 16/16 PASS

## P2-JAVA-LINT-FIX: Java emitter のハードコード違反を修正する
1. [x] P2-JAVA-LINT-S1 — 全カテゴリ 0 件（2026-03-31 時点。skip_pure_python 追加前）
