...
> **2026-04-04** — emitter lint に Python メソッド名ハードコード検出追加（23 パターン）。parity check の全件 SKIP → FAIL 修正。pytra-cli.py デフォルト出力先を work/tmp/ に変更。lint 常時 10 カテゴリ化。callable_optional_none fixture 追加。emitter guide §12.6 callable 型写像・§14.1 lint ドキュメント追加。mapping.json 完全修飾キー計画起票。Zig fixture 146/146 PASS。Julia fixture 145/146。
