<a href="../../ja/plans/p0-lua-parity-test-sample-rollout.md">
...
- Sample parity (18 `sample/py` cases) fully passes under `--targets lua`.
...
- [x] [ID: P0-LUA-PARITY-ALL-01-S2-02] Run `runtime_parity_check --case-root sample --targets lua`, fix mismatches, and reach all pass.
...
- 2026-03-01: `python3 tools/check/runtime_parity_check.py --case-root sample --targets lua --ignore-unstable-stdout` was incomplete (pass=3, fail=15).
...
- 2026-03-01: `python3 tools/check/runtime_parity_check.py --case-root sample --targets lua --ignore-unstable-stdout` passed (18/18, fail=0).
