<a href="../../ja/plans/p1-rs-runtime-externalization.md">
...
- `tools/check/runtime_parity_check.py` (Rust path)
- `tools/gen/regenerate_samples.py` and `sample/rs` regeneration
