<a href="../../ja/plans/archive/20260308-p0-cpp-pyruntime-dynamic-bridge-retirement.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-DC2626?style=flat-square"></a>
...
- `PYTHONPATH=src python3 tools/unittest/ir/test_east_core.py -v`
