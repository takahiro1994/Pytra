<a href="../../ja/plans/p0-test-reorg.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-DC2626?style=flat-square"></a>
...
5. `pytra-cli` の resolve/compile/optimize/link が test/include/ の新パスで動作（parity 維持）
