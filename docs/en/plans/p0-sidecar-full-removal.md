<a href="../../ja/plans/p0-sidecar-full-removal.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-DC2626?style=flat-square"></a>
...
- `tools/check/check_py2*_transpile.py` / `tools/check/runtime_parity_check.py` / 関連 test
