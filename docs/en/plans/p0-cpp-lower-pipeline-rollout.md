...
- Existing C++ transpile regressions (`tools/check/check_py2cpp_transpile.py`) pass with no regressions.
...
- 2026-03-02: Verified no regressions with `tools/check/check_py2cpp_transpile.py` (136/136 pass, skip6), `tools/gen/regenerate_samples.py --langs cpp --stems 01_mandelbrot,08_langtons_ant,18_mini_language_interpreter --force`, and `tools/check/runtime_parity_check.py --case-root sample --targets cpp 01_mandelbrot 08_langtons_ant 18_mini_language_interpreter --ignore-unstable-stdout` (3/3 pass) (S4-02).
